...
class Booking extends Model {
  ...
  Booking({this.id, this.dateTime, this.description, this.status, this.progress, this.total, this.tax, this.rate, this.user, this.eService, this.address, this.paymentMethod});
