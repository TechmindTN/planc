            ...
            SliverAppBar(
              ...
              flexibleSpace: FlexibleSpaceBar(
                  ...
                  background: Container(
                    ...
                    child: Column(
                      children: [
                        Text("4.5", style: Get.textTheme.headline1.merge(TextStyle(color: Get.theme.hintColor, fontSize: 36, fontWeight: FontWeight.w600))),
                        Wrap(
                          children: Ui.getStarsList(4.5, size: 32),
                        ),
                        Text(
