...
//      });
    ...
    return Scaffold(
        ...
        bottomNavigationBar: Container(
          ...
          child: Column(
            children: [
              Center(child: Text("Total Price: "+controller.calculateSum(servicecontrol.text, workforcecontrol.text, studycontrol.text, discountcontrol.text)+'TND'),),
              Row(
                children: [
                  Expanded(
                    child: MaterialButton(
                      ...
                      onPressed: () {
                        ...
                        controller.saveBill(_billForm,context);
                        ...
                        showDialog(
                            ...
                            builder: (context) {
                              return AlertDialog(
                                ...
                                scrollable: true,
                                // title: Text("Total: "+controller.calculateMat(matpricecontrol.text,matcountcontrol.text).toString()+"TND"),
                                content: Container(
                                  width:
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: ListView(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          height:  MediaQuery.of(context).size.height *0.16,
                                          width:  MediaQuery.of(context).size.width *0.7,                                          child: TextFieldWidget(
                                        ...
                                        Center(child: Text("Total: "+controller.calculateMat(matpricecontrol.text,matcountcontrol.text).toString()+"TND",
